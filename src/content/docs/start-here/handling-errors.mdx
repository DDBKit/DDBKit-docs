...
```
Which will result in the following message being sent:

<div class="discord-messages">
  <div class="discord-message">
      <div class="discord-interaction">
        <img class="discord-interaction-author-avatar" src="https://cdn.discordapp.com/embed/avatars/0.png" alt=""></img>
