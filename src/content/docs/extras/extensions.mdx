...
This note does not apply to v0.x versions of DDBKit.
</Aside>
...
extension ExtensibleCommand {
    ...
    public func catchAction(_ action: @escaping (any Error, BaseContextCommand, any GatewayManager, DiscordCache, Interaction, DatabaseBranches) -> Void) -> Self
